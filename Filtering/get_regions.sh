...
end_ndhF=$(cat $regionsDir"/regions/region03_SSC.txt" | grep $sampleID"\t" | grep "ndhF_" | cut -f4)
start_ndhA=$(cat $regionsDir"/regions/region03_SSC.txt" | grep $sampleID"\t" | grep "ndhA_" | cut -f3)
end_ndhA=$(cat $regionsDir"/regions/region03_SSC.txt" | grep $sampleID"\t" | grep "ndhA_" | cut -f4)
